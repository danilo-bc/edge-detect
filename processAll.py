...
# fileList = glob.glob("./images/aerialMod/*.pgm")

# print("Parte deterministica")
# for file in fileList:
#    print("Processando: ",file)
#    src,edges_det = ds.detectAndShow(file,errRate=0.05,show=False)
#    sw.saveHex("./results/det/errRate/"+file.split('/')[-1][:-4]+"0_05.txt",edges_det)

# print("Parte estocastica")
# for file in fileList:
#    print("Processando: ",file)
#    src,edges_stoch = sw.rayDetectAndShow(file,errRate=0.02,show=False)
