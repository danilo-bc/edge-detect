 ...
 */
module LFSR_4_bit_added_zero_Sobel3x3_X_4b_g2(//Linear feedback shift register
	input [3:0] seed, //Initial value
	output [3:0] data, //Current value
	...
	always @(posedge clk or posedge reset) begin
		...
		else if (enable) shift_reg <= {shift_reg[2:0], shift_in};
	end


	wire xor_out;
	assign xor_out = shift_reg[3] ^ shift_reg[2];

	wire zero_detector;
	assign zero_detector = ~(|(shift_reg[2:0]));
