 ...
 */
module MReSC_wrapper_Sobel3x3_X_4b_g2( //handles stochastic/binary conversion for ReSC
	input [3:0] x_1_bin, //binary value of input 1
	input [3:0] x_2_bin, //binary value of input 2
	input [3:0] x_3_bin, //binary value of input 3
	input [3:0] x_4_bin, //binary value of input 4
	input [3:0] x_5_bin, //binary value of input 5
	input [3:0] x_6_bin, //binary value of input 6
	input start, //signal to start counting
	output reg done, //signal that a number has been computed 
	output reg [3:0] z_bin, //binary value of output
	...
	reg [3:0] w6_bin = 4'd0;
	reg [3:0] w7_bin = 4'd0;
	reg [3:0] w8_bin = 4'd11;
	reg [3:0] w9_bin = 4'd8;
	reg [3:0] w10_bin = 4'd6;
	reg [3:0] w11_bin = 4'd0;
	reg [3:0] w12_bin = 4'd8;
	reg [3:0] w13_bin = 4'd5;
	reg [3:0] w14_bin = 4'd0;
	reg [3:0] w15_bin = 4'd0;
	reg [3:0] w16_bin = 4'd15;
	reg [3:0] w17_bin = 4'd10;
	reg [3:0] w18_bin = 4'd8;
	reg [3:0] w19_bin = 4'd5;
	reg [3:0] w20_bin = 4'd10;
	reg [3:0] w21_bin = 4'd10;
	reg [3:0] w22_bin = 4'd5;
	reg [3:0] w23_bin = 4'd0;
	reg [3:0] w24_bin = 4'd15;
	reg [3:0] w25_bin = 4'd15;
	reg [3:0] w26_bin = 4'd11;
	reg [3:0] w27_bin = 4'd8;
	reg [3:0] w28_bin = 4'd15;
	reg [3:0] w29_bin = 4'd10;
	reg [3:0] w30_bin = 4'd8;
	reg [3:0] w31_bin = 4'd5;
	reg [3:0] w32_bin = 4'd11;
	reg [3:0] w33_bin = 4'd8;
	reg [3:0] w34_bin = 4'd6;
	reg [3:0] w35_bin = 4'd0;
	reg [3:0] w36_bin = 4'd8;
	reg [3:0] w37_bin = 4'd5;
	reg [3:0] w38_bin = 4'd0;
	reg [3:0] w39_bin = 4'd0;
	reg [3:0] w40_bin = 4'd15;
	reg [3:0] w41_bin = 4'd11;
	reg [3:0] w42_bin = 4'd6;
	reg [3:0] w43_bin = 4'd6;
	reg [3:0] w44_bin = 4'd11;
	reg [3:0] w45_bin = 4'd8;
	reg [3:0] w46_bin = 4'd6;
	reg [3:0] w47_bin = 4'd0;
	reg [3:0] w48_bin = 4'd15;
	reg [3:0] w49_bin = 4'd15;
	reg [3:0] w50_bin = 4'd11;
	reg [3:0] w51_bin = 4'd8;
	reg [3:0] w52_bin = 4'd15;
	reg [3:0] w53_bin = 4'd10;
	reg [3:0] w54_bin = 4'd8;
	reg [3:0] w55_bin = 4'd5;
	reg [3:0] w56_bin = 4'd15;
	reg [3:0] w57_bin = 4'd15;
	reg [3:0] w58_bin = 4'd15;
	reg [3:0] w59_bin = 4'd11;
	reg [3:0] w60_bin = 4'd15;
	reg [3:0] w61_bin = 4'd15;
	reg [3:0] w62_bin = 4'd11;
	reg [3:0] w63_bin = 4'd8;
	...
	wire [3:0] randx_2_0;
	LFSR_4_bit_added_zero_Sobel3x3_X_4b_g2 rand_gen_x_2_0 (
		.seed (4'd0),
		.data (randx_2_0),
		.enable (running),
		.restart (init),
	...
	wire [3:0] randx_3_0;
	LFSR_4_bit_added_zero_Sobel3x3_X_4b_g2 rand_gen_x_3_0 (
		.seed (4'd0),
		.data (randx_3_0),
		.enable (running),
		.restart (init),
	...
	wire [3:0] randx_4_0;
	LFSR_4_bit_added_zero_Sobel3x3_X_4b_g2 rand_gen_x_4_0 (
		.seed (4'd0),
		.data (randx_4_0),
		.enable (running),
		.restart (init),
	...
	wire [3:0] randx_5_0;
	LFSR_4_bit_added_zero_Sobel3x3_X_4b_g2 rand_gen_x_5_0 (
		.seed (4'd0),
		.data (randx_5_0),
		.enable (running),
		.restart (init),
	...
	wire [3:0] randx_6_0;
	LFSR_4_bit_added_zero_Sobel3x3_X_4b_g2 rand_gen_x_6_0 (
		.seed (4'd0),
		.data (randx_6_0),
		.enable (running),
		.restart (init),
	...
	wire [3:0] randw;
	LFSR_4_bit_added_zero_Sobel3x3_X_4b_g2 rand_gen_w (
		.seed (4'd11),
		.data (randw),
		.enable (running),
		.restart (init),
	...
	reg [3:0] count; //count clock cycles
	wire [3:0] neg_one;
	assign neg_one = -1;
